<template>
  <div class="pop-flex">
          ...
          <div class="i-comment">
            ...
            <div v-for="(comment,mainIndex) in commentList" :key="comment.cid" class="comment-item">
              ...
              <div class="item-reply" v-if="comment.reply.length>0">
                <div
                  v-for="(reply,subIndex) in comment.reply"
                  :key="subIndex"
                  class="item-reply-wrapper"
                >
                  <div class="item-header">
    ...
    <div id="barWrapper">
      <div class="sideBar">
        <div class="ad" v-for="ad in barAds" :key="ad">
          <a :href="ad.url" target="_blank">
            <img :src="ad.img" />
          </a>
        </div>
        <div class="menuList">
          ...
          <ul>
            <li v-for="(menu,index) in menuList" :key="index">
              <a :href="`#${menu}`" :class="{active:index==i}" @click="i=index">{{menu}}</a>
            </li>
          </ul>
        </div>
      </div>
...
export default {
  ...
  mounted() {
    ...
    Array.prototype.forEach.call(
      document.getElementById("art-content").getElementsByTagName("img"),
      (dom) => {
